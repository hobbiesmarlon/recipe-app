...
const EditProfile: React.FC = () => {
  ...
  const handleSave = () => {
    alert('Saved (mock). In a real app this would PATCH to the server.');
    navigate('/profile');
  };
        ...
        <section className="pt-6">
          <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 mb-6">
            <p className="text-sm text-primary font-medium leading-relaxed">
              <span className="font-bold">Note:</span> If you signed up with X or Google, your display name and username are synced with your social account and cannot be edited here.
            </p>
          </div>
